...
mongoose.connect('mongodb://localhost:27017/webapp-db',{ useNewUrlParser: true, useUnifiedTopology: true  })
...
app.get('/walkthrough', function (req, res, next) {
  req.session.saveWalkthrough = true;
  res.end();
})

app.get('/complicated', function (req, res, next) {
  console.log(req.session.saveWalkthrough);
})
